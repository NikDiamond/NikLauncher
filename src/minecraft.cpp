...
void minecraft::launch()
{
    ...
    connect(proc, SIGNAL(started()), this, SLOT(startedSlot()));
    //Java аргументы
    ...
    proc->start(sett.javaPath,  args);
}

void minecraft::startedSlot()
{
    emit started();
}
